"""
File name: test_sensing_module_response_2.py
Author: Yerbol Aussat
Python Version: 2.7

Script to test response of sensing modules. IP addresses and port numbers of sensing modules to test can be specified
